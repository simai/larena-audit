...
return [
    ...
    'operations' => ['Created' => 'Создание', 'Updated' => 'Изменение', 'Published' => 'Публикация', 'Unpublished' => 'Снятие с публикации', 'Permission denied' => 'Доступ запрещён', 'Page activity' => 'Действие со страницей', 'Security activity' => 'Действие безопасности'],
